...
RF_second_step_lmer <- data_add2

write.csv(RF_second_step_lmer,'RF_second_step_lmer.csv', row.names = FALSE)

RF_second_step_lmer <- read.csv('RF_second_step_lmer.csv')
...
RF_second_step_lmer$D1KMAY_ID <- data_add$D1KMAY_ID

id <- dataa$D1KMAY_ID[1]

data_plot <- data.frame("observed" = dataa$PM25,
                        "predicted" = RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25, dataa$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datab$PM25,
                        "predicted" = RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25, datab$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datad$PM25,
                        "predicted" = RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25, datad$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datae$PM25,
                        "predicted" = RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25, datae$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = dataf$PM25,
                        "predicted" = RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25, dataf$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datak$PM25,
                        "predicted" = RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25, datak$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datal$PM25,
                        "predicted" = RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(RF_second_step_lmer[RF_second_step_lmer$D1KMAY_ID == id, ]$PM25, datal$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
#Represent predicted vs observed for Stations and CMAQ after RF_second_step_lmer
...
#### end Represent predicted vs observed for Stations and CMAQ after RF_second_step_lmer ####
...
RF_second_step_lmer$lon_WRF <- lon_WRF
RF_second_step_lmer$lat_WRF <- lat_WRF

RF_second_step_lmer <- RF_second_step_lmer[RF_second_step_lmer$PM25 < 100, ]
RF_second_step_lmer$PM25 <- ifelse(RF_second_step_lmer$PM25 < 0,0, RF_second_step_lmer$PM25)
...
write.csv(data_year_2015_average, "C:/Users/jcord/Documents/AIRTEC/PM/NetCDF/data_year_2015_average_PM_total_AOD_RF_second_step_lmer.csv", row.names = FALSE)
