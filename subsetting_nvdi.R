...
#parent_dir<-"C:/Users/Jose María/Documents/AIRTEC/PM/Paper_2/GIS/joining"
...
for (i in 1:12)
{
  ...
  else {print(paste("no hay datos para el día",i)) 
    next}
}
...
for (i in 360:365)
{
  ...
  else print(paste0("No hay datos en el día ",i))
}
