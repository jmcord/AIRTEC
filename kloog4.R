...
colnames(point_data)[3] <- "X_cell"
colnames(point_data)[4] <- "Y_cell"
...
colnames(capa1_data)[3] <- "X_cell"
colnames(capa1_data)[4] <- "Y_cell"
...
colnames(capa2_data)[3] <- "X_cell"
colnames(capa2_data)[4] <- "Y_cell"
...
colnames(resuspension_data)[3] <- "X_cell"
colnames(resuspension_data)[4] <- "Y_cell"
...
data_add_scaled <- scale(data_add[,!colnames(data_add) %in% c('D1KMAY_ID','yearday')],
                         scale = fe_scales[-12], center = fe_centers[-12])
...
write.csv(data_year_2015_average, "C:/Users/jcord/Documents/AIRTEC/PM/NetCDF/data_year_2015_average_PM_total.csv")
