...
data_model3 <- data_model2[, colnames(data_model2) %in% c('T','pop_index','ele','LU_index','VH_KM','u_wind','v_wind',
                                                          'SLP','s_hum','NDVI','PBL','yearday','PM25_capa1'
...
data_model3 <- data_model2[, colnames(data_model2) %in% c('T','pop_index','ele','LU_index','VH_KM','u_wind','v_wind',
                                                          'SLP','s_hum','NDVI','PBL','yearday','PM25_capa1'
                                                          ,'PM25_capa2','PM25_resuspension','Month','PM25')] %>% na.omit()
...
data_model3 <- XG_first_AOD[, colnames(XG_first_AOD) %in% c('T','pop_index','ele','LU_index','VH_KM','u_wind','v_wind',
                                                            'SLP','s_hum','NDVI','PBL','yearday','PM25_capa1'
                                                            ,'PM25_capa2','PM25_resuspension','Month')]

data_model3 <- data_model3[, c('T','SLP','ele','s_hum','u_wind','v_wind','PBL','Month','NDVI','LU_index','pop_index','VH_KM'
                               ,'PM25_capa1'
...
write.csv(XG_first_AOD_XG,'XG_no_AOD_XG.csv',row.names = FALSE)

XG_no_AOD_XG <- read.csv('XG_no_AOD_XG.csv')
...
XG_no_AOD_XG$D1KMAY_ID <- D1KMAY

data_model3 <- XG_no_AOD_XG[XG_no_AOD_XG$D1KMAY_ID %in% ids, ]
...
XG_no_AOD_XG$D1KMAY_ID <- data_add$D1KMAY_ID
...
ea <- data.frame("observed" = dataa$PM25,
                 "predicted" = XG_no_AOD_XG[XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25)
...
data_plot <- data.frame("observed" = datab$PM25,
                        "predicted" =  XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols( XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25, datab$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datac$PM25,
                        "predicted" =  XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols( XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25, dataa$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datad$PM25,
                        "predicted" =  XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols( XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25, datad$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datae$PM25,
                        "predicted" =  XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols( XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25, datae$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = dataf$PM25,
                        "predicted" =  XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols( XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25, dataf$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datak$PM25,
                        "predicted" =  XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols( XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25, datak$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datal$PM25,
                        "predicted" =  XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols( XG_no_AOD_XG[ XG_no_AOD_XG$D1KMAY_ID == id, ]$PM25, datal$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
d = densCols(df$observed, df$predicted, colramp = colorRampPalette(rev(rainbow(10, end = 2/6))))
...
XG_no_AOD_XG$lon_WRF <- lon
XG_no_AOD_XG$lat_WRF <- lat
XG_no_AOD_XG$D1KMAY_ID <- data_add2$D1KMAY

XG_no_AOD_XG <- XG_no_AOD_XG[XG_no_AOD_XG$PM25 < 100, ]
XG_no_AOD_XG <- XG_no_AOD_XG[XG_no_AOD_XG$PBL < 5000, ]
XG_no_AOD_XG$PM25 <- ifelse(XG_no_AOD_XG$PM25 < 0,0, XG_no_AOD_XG$PM25)
...
write.csv(data_year_2015_average, "C:/Users/jcord/Documents/AIRTEC/PM/NetCDF/meteo_2015_average_PM_total_no_AOD_XG.csv")
