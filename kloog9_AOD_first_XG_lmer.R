...
write.csv(XG_first_AOD, 'XG_first_AOD.csv', row.names = FALSE)
XG_first_AOD <- read.csv('XG_first_AOD.csv')
...
#10-fold-cross-validation for XG_first_AOD_LMER
...
write.csv(data_add2,'XG_first_AOD_lmer.csv',row.names = FALSE)

XG_first_AOD_lmer <- read.csv('XG_first_AOD_lmer.csv')
...
XG_first_AOD_lmer$D1KMAY_ID <- data_add$D1KMAY_ID


id <- dataa$D1KMAY_ID[1]

data_plot <- data.frame("observed" = dataa$PM25,
                        "predicted" = XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25, dataa$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datab$PM25,
                        "predicted" = XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25, datab$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datad$PM25,
                        "predicted" = XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25, datad$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datae$PM25,
                        "predicted" = XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25, datae$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = dataf$PM25,
                        "predicted" = XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25, dataf$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datak$PM25,
                        "predicted" = XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25, datak$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
data_plot <- data.frame("observed" = datal$PM25,
                        "predicted" = XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25,
                        "d" = densCols(XG_first_AOD_lmer[XG_first_AOD_lmer$D1KMAY_ID == id, ]$PM25, datal$PM25, colramp = colorRampPalette(rev(rainbow(10, end = 4/6)))))
...
#Represent predicted vs observed for some Stations after XG-lmer ####
...
#### end Represent predicted vs observed for some Stations after XG-lmer ####

#Obtain yearly mean by cell


XG_first_AOD_lmer$lon_WRF <- lon_WRF
XG_first_AOD_lmer$lat_WRF <- lat_WRF

XG_first_AOD_lmer <- XG_first_AOD_lmer[XG_first_AOD_lmer$PM25 < 100, ]
XG_first_AOD_lmer$PM25 <- ifelse(XG_first_AOD_lmer$PM25 < 0,0, XG_first_AOD_lmer$PM25)
...
write.csv(data_year_2015_average, "C:/Users/jcord/Documents/AIRTEC/PM/NetCDF/data_year_2015_average_PM_total_XG_AOD_lmer.csv")
